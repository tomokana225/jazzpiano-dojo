...
export const STANDARDS: Standard[] = [
  ...
  },
  {
    ...
    titleJa: "All The Things You Are ii-V-Iチェーン練習ループ",
    titleEn: "All The Things You Are",
    key: Ab,
    suggestedBpm: 132,
    descriptionJa:
      "曲中で最も有名な、Ab→C→Eb→Gと転調しながら連なる ii-V-I チェーンを凝縮した16小節の練習ループ。転調ごとにコードスケールを切り替えるアドリブ練習に最適。",
    chords: [
